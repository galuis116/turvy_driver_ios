...
import {  StyleSheet, Text, View,Dimensions, Image, TouchableOpacity,TouchableHighlight, Alert,Linking, BackHandler, Animated, AppState, Pressable, DeviceEventEmitter, Switch,FlatList,KeyboardAvoidingView, SafeAreaView, TextInput as MyInput, Platform} from 'react-native';
...
//snapHeight:Platform.isPad ? 450 : 300,
    ...
    ViolentEndTrip = () => {
        ...
        console.log("VOLIENT END - IDSTANCE TRAVELL ",this.state.distanceTravelled);
