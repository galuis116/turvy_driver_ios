...
export default class BookingMap extends Component {
  ...
  componentDidMount = async () => {
              ...
              .then((result) => {
                if (result.status === 1) {
                  ...
                  AsyncStorage.setItem(
                    "destination_lat",
                    JSON.stringify(bookData.destination_lat)
                  );
                  AsyncStorage.setItem(
                    "destination_lng",
                    JSON.stringify(bookData.destination_lng)
                  );
    ...
    Geolocation.getCurrentPosition(
      (currntPos) => {
        //console.log('firebase trip_path',currntPos);
        this.setState({
          driverCoordinate: new AnimatedRegion({
    ...
    Geolocation.watchPosition(
      (curCoords) => {
        ...
        this.setState(
          {
            coordinates: [
              curCoords.coords.longitude,
              curCoords.coords.latitude,
            ],
  ...
  componentWillUnmount = () => {
    ...
    this.intervalModeChange !== undefined
      ? clearTimeout(this.intervalModeChange)
      : null;
    this.clearTimer();
  ...
  updateDriverCoordinates = async (pos) => {
    ...
    if (this.state.departed == true) {
      ...
      this.setState(
        {
          distanceTravelled:
            parseFloat(distanceTravelled) + this.calcDistance(newLatLngs),
        ...
        () => {
          ...
          db.collection("trip_path")
            ...
            .update({
              location: firestore.FieldValue.arrayUnion(
        ...
        .then((res) => {
          Linking.openURL(mapurl)
            ...
            .catch((err) => {
              ...
              Alert.alert(
                "Google map open error",
                "Please check google map navigation app is install on your device",
                [
                  {
                    text: "Ok",
                    onPress: () => null,
        ...
        .then((res) => {
          ...
          Linking.openURL(wazeUrl)
            ...
            .catch((err) => {
              ...
              Alert.alert(
                "Waze open error",
                "Please check waze navigation app is install on your device",
                [
                  {
                    text: "Ok",
                    onPress: () => null,
  ...
  clearWaitTimer = () => {
    // Handle an undefined timer rather than null
    this.chargeWaitTimer !== undefined
      ? clearTimeout(this.chargeWaitTimer)
      : null;
  ...
  ViolentEndTrip = () => {
    ...
    console.log("VOLIENT END DD", this.state.bookrequest.id);
    console.log("VOLIENT END -- MAP latitude", this.state.mapLatitude);
    console.log("VOLIENT END -- MAP longitude", this.state.mapLongitude);
    console.log(
      "VOLIENT END - IDSTANCE TRAVELL ",
      this.state.distanceTravelled
    );
    console.log("VOLIENT END - Duration ", this.state.duration);
    db.collection("trip_path")
      .doc(JSON.stringify(this.state.bookrequest.id))
      .update({
        location: firestore.FieldValue.arrayUnion(
  ...
  onDidFinishLoadingMap = () => {
    ...
    fetch(
      "https://api.mapbox.com/directions/v5/mapbox/driving/" +
        locationcordsapistr +
        "?geometries=geojson&overview=full&access_token=sk.eyJ1IjoiamttaWxsYSIsImEiOiJjbGlzM3JtMmswczN5M2NxdmR2cDB3bTNuIn0.vBo7vBXjCnpxsyHAwe4jZw",
      {
        method: "GET",
      }
    )
  ...
  render() {
    ...
    return (
      <>
        {this.state.bannerDistance ? null : this.state.mapbox ? null : (
          <TopBar />
        )}
        ...
        {this.state.tripEndDone ? <DriverRating {...this.props} /> : null}
        <Modal
          animationType="slide"
          transparent={true}
        ...
        >
          ...
          >
            ...
            {this.state.cancelSuccess === "" ? (
                ...
                >
                  <Col size={4}>
                    <Button
                      mode="contained"
                      color={"#135AA8"}
                      onPress={() => this._submitCancelTrip()}
                    >
                      Done
                    </Button>
                  </Col>
              ...
              <Row style={{ marginHorizontal: moderateScale(10) }}>
                <Col style={{ alignItems: "center", justifyContent: "center" }}>
                  <Text style={{ fontSize: moderateScale(20), color: "green" }}>
                    {this.state.cancelSuccess}
                  </Text>
                </Col>
              </Row>
          ...
          >
            ...
            <Row style={{ height: moderateScale(50) }}>
              ...
              >
                ...
                <Text style={{ fontSize: moderateScale(16), color: "#FFF" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <TouchableOpacity
                  onPress={() => this.openSOSDialScreenCall("000")}
                >
            ...
            <Row size={1}>
              ...
              >
                <TouchableOpacity
                  onPress={() => this.openSOSDialScreenCall("+61417691066")}
                >
                  <Feather name="phone-call" size={24} color="#474D81" />
                </TouchableOpacity>
              </Col>
