                                              ...
                                              <Row style={{height:moderateScale(200)}}>
                                                <Col style={{alignItems:'center',margin:moderateScale(10)}}>
                                                   <Text style={{fontSize:20,textAlign:'center'}}>Are you sure to delete your Account?</Text>
                                                    <Text style={{alignItems:'center',fontSize:16,color:'gray',padding:15,lineHeight:25,paddingHorizontal:15}}>Once you confirm, support team will check your account details, if all is good. We will delete your account. It will take 24 to 48 hours.
