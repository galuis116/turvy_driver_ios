                ...
                <Grid>
                  <Row style={{ height: moderateScale(200) }}>
                    ...
                    >
                      ...
                      >
                        Once you confirm, support team will check your account
                        details, if all is good. We will delete your account. It
                      ...
                      >
                        It will delete your account permanently.
                      </Text>
                    </Col>
                  </Row>
                  <Row>
                    ...
                    <Col>
                      <View style={{ marginLeft: 15, marginRight: 15 }}>
                        ...
                        >
                          ...
                          >
                            <Text style={[styles.priBtnTxt, { color: "#000" }]}>
                              Don't Delete
                            </Text>
                          </LinearGradient>
                        </TouchableHighlight>
            ...
            >
              ...
              <>
                <Row style={{ height: moderateScale(100) }}>
                  <Col
                    style={{ alignItems: "center", margin: moderateScale(10) }}
                  >
                    <Text style={{ fontSize: 20, textAlign: "center" }}>
