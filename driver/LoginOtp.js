...
const LoginOtp = ({props}) => {
	...
	const [countryitem, setCountryitem] = useState({"id": 13, "name": "AUSTRALIA", "nicename": "Australia", "phonecode": "61"});
	...
	const loginOTP = async () =>{
  	...
  	async function loginfb(myPhone){
  ...
  <ImageBackground source={require('../assets/images/turvy-landing-page.jpg')} resizeMode="cover" style={{width:'100%',height:'100%'}} /> 
		...
		<ScrollView keyboardShouldPersistTaps='handled'>
			<View style={ Platform.isPad ? {flex:1,alignItems:'center',marginBottom:100,marginTop:60} : {flex:1,alignItems:'center',marginBottom:30} }>
	        	<Image
  ...
  placeholder='Enter Mobile Number' inputStyle={[ ( Platform.isPad ? styles.inputStyleipad : styles.inputStyle ),styles.marginTop10,{paddingLeft:65,borderColor:'#4795bb',color:'#1f71bd',fontSize:16}]}
