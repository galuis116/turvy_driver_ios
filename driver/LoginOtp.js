...
const LoginOtp = ({ props }) => {
              ...
              .then((res) => {
                ...
                if (res.error === "Unauthenticated.") {
                  ...
                  AsyncStorage.setItem(
                    "state_id",
                    JSON.stringify(res.data.state_id)
                  );
  ...
  async function loginfb(myPhone) {
    if (mobileNumber == "7709048577") {
      return navigation.replace("VerificationOtp", {
        phone: mobileNumber,
            ...
            <View
              style={
                Platform.isPad
                  ...
                  : { flex: 1, alignItems: "center", marginBottom: 30 }
              }
            >
              <Image
            ...
            <View style={{ paddingLeft: 30, paddingRight: 30 }}>
              <View
                style={[
                  ...
                  { borderColor: "#4795bb", marginBottom: 5 },
                ]}
              >
                <Dropdown
              ...
              <Input
                ...
                inputStyle={[
                  Platform.isPad ? styles.inputStyleipad : styles.inputStyle,
                  styles.marginTop10,
                  {
                    paddingLeft: 65,
                    borderColor: "#4795bb",
