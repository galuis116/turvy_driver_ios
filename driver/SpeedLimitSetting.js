    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          >
            <Text style={{ fontSize: 18 }}>Show Speed Limit</Text>
            <Switch
          ...
          <View style={styles.titleHead}>
            <Text>
              Speed limit{" "}
              <Text style={{ fontWeight: "bold" }}>below 60km/h</Text>
            </Text>
          </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={styles.RadioButton}>
                <RadioButton
                  value="1"
                  status={
                    this.state.limitBelow === "1" ? "checked" : "unchecked"
                  }
              ...
              <View style={styles.RadioButton}>
                <RadioButton
                  value="10"
                  status={
                    this.state.limitBelow === "10" ? "checked" : "unchecked"
                  }
              ...
              <View style={styles.RadioButton}>
                <RadioButton
                  value="15"
                  status={
                    this.state.limitBelow === "15" ? "checked" : "unchecked"
                  }
          ...
          <View style={styles.titleHead}>
            <Text>
              Speed limit{" "}
              <Text style={{ fontWeight: "bold" }}>60km/h or above</Text>
            </Text>
          </View>
          <View style={{ paddingHorizontal: 15 }}>
            <View style={{ flexDirection: "row" }}>
              <View style={styles.RadioButton}>
                <RadioButton
                  value="1"
                  status={
                    this.state.limitAbove === "1" ? "checked" : "unchecked"
                  }
              ...
              <View style={styles.RadioButton}>
                <RadioButton
                  value="10"
                  status={
                    this.state.limitAbove === "10" ? "checked" : "unchecked"
                  }
              ...
              <View style={styles.RadioButton}>
                <RadioButton
                  value="15"
                  status={
                    this.state.limitAbove === "15" ? "checked" : "unchecked"
                  }
