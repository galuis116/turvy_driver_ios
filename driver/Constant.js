...
export const styles = StyleSheet.create({
	...
	inputStyleipad: {backgroundColor:'#FFF',borderWidth:1,borderColor:'#cecece',borderRadius:40,height:50,padding:10,paddingLeft:20,overflow:'hidden',color:'#8c8c8c',fontFamily: "Metropolis-Regular"},
