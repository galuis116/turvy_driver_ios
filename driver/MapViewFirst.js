...
export default class MapViewFirst extends React.Component {
  ...
  async componentDidMount() {
    ...
    //console.log('Appearance mode============>', Platform.isPad)
    this.setState({
    ...
    Geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        Alert.alert(
          ...
          "We are not able to get your location, Please check location service is on or reboot your phone.",
          [
            {
              text: "Ok",
              onPress: () => null,
    ...
    Geolocation.watchPosition(
      (pos) => {
        //console.log('currnt Pos========:', currntPos);
  ...
  updateFirbaseDriver = () => {
    if (this.state.isDriOnline) {
      ...
      geocollection.doc(this.state.driverId).update({
        isBusy: "no",
      });
    }
  };
