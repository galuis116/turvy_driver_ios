...
const origin = { latitude: -34.0746573, longitude: 151.01108 };
const destination = { latitude: -34.0746573, longitude: 151.01108 };
...
export default class MapViewOffline extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      radius: 40,
      sourceLocation: {},
      latitudecur: -34.0746573,
      longitudecur: 151.01108,
      curlocatdesc: "",
      ...
      checkOnlineTime: 0,
      offlineTimeText: "",
      coordinates: [151.01108, -34.0746573],
    ...
    Geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        Alert.alert(
          ...
          "We are not able to get your location, Please check location service is on or reboot your device.",
          [
            {
              text: "Ok",
              onPress: () => null,
    ...
    if (airportCords.length > 0) {
      for (let k = 0; k < airportCords.length; k++) {
        ...
        for (i = 0; i < airportCords[k].coords.length; i++) {
          cordArr[i] = [
            Number(airportCords[k].coords[i].longitude),
            Number(airportCords[k].coords[i].latitude),
          ];
        }
        ...
        {this.state.isDriverApproved ? (
          ...
          >
            ...
            {this.state.showBlocked ? (
              ...
              >
                <Title style={[stylesLocal.White, { alignSelf: "center" }]}>
                  You can go online after
                </Title>
                <Paragraph
                  style={[
                    stylesLocal.White,
              ...
              >
                <View style={{ paddingBottom: 15 }}>
                  ...
                  >
                    Touch here to go online to start accepting jobs
                  </Text>
                </View>
              </TouchableOpacity>
            ) : null}
          ...
          >
            ...
            >
              ...
              <Paragraph style={stylesLocal.White}>
