          ...
          >
            <Grid style={{ flex: 1, width: width - 20, marginTop: -30 }}>
              ...
              <Row style={{ height: 50, marginTop: 10 }}>
                ...
                >
                  <Text style={{ color: "#155aa8", fontSize: 22 }}>
                    {this.state.pickupInfo.duration}
                  </Text>
                </Col>
                <Col
                  size={5}
                ...
                >
                  <Text style={{ color: "gray", fontSize: 18 }}>
                    {this.state.pickupInfo.distance}
                  </Text>
                </Col>
              </Row>
              ...
              <Row style={{ height: 40 }}>
                ...
                >
                  ...
                  >
                    {this.state.bookrequest.destination}
              ...
              >
                <Col size={1}>
                  <Text style={{ alignSelf: "center", color: "#155aa8" }}>
                    {this.state.prcount}
                  </Text>
                </Col>
                <Col size={11}>
              ...
              <Row style={{ height: 30 }}>
                ...
                >
                  {this.state.tripDistance.distance > 50 ? (
                    <Text style={{ fontSize: 18, color: "#155aa8" }}>
                      Long Trip ({this.state.tripDistance.distance}+ Km)
                    </Text>
                  ) : (
                    <Text style={{ fontSize: 18, color: "#155aa8" }}>
                      {this.state.tripDistance.duration} min Trip (
                      {this.state.tripDistance.distance}+ Km)
                    </Text>
                  )}
                </Col>
              </Row>
  ...
  async _onPressAccept() {
    ...
    AsyncStorage.getItem("accesstoken").then((value) => {
      if (value != "" && value !== null) {
        ...
        fetch(
          DOMAIN + "api/driver/book/" + this.state.bookrequest.id + "/accept",
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
          ...
          .then((result) => {
            ...
            if (result.status === 1) {
              ...
              this.props.navigation.navigate("BookingMap", {
                bookId: this.state.bookrequest.id,
              });
            }
          });
      }
    ...
    return (
      <>
        ...
        <MapView>
          ...
          {Object.keys(this.state.startGeo).length > 0 &&
          Object.keys(this.state.currentLoc).length > 0 ? (
            <MapViewDirections
              resetOnChange={false}
              region={"AU"}
