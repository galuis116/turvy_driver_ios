        ...
        <>
          ...
          <View style={styles.RadioButton}>
            <RadioButton
              value="Max volume"
              status={
                this.state.tripVolume === "Max volume" ? "checked" : "unchecked"
              }
          ...
          <View style={styles.RadioButton}>
            <RadioButton
              ...
              status={
                this.state.tripVolume === "Control with phone"
                  ? "checked"
                  : "unchecked"
              }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <Text style={{ fontSize: 18 }}>Voice Navigation</Text>
            <Switch
          ...
          >
            <Text style={{ fontSize: 18 }}>Read rider messages</Text>
            <Switch
              trackColor={{ false: "#767577", true: "#767577" }}
