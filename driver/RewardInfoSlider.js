                ...
                <Grid style={{ marginTop: -15 }}>
                      ...
                      >
                        ...
                        >
                          <MaterialCommunityIcons
                            ...
                            name="cards-diamond"
                          />
                          {this.state.tripInfo.driver_points
                            ? this.state.tripInfo.driver_points
                            : 0}
                        </Button>
                      </View>
                  ...
                  >
                    <Text style={{ fontSize: 16, textAlign: "center" }}>
                      {`Earn ${
                        this.state.tripInfo.qualify_points -
                        this.state.tripInfo.driver_points
                      } more points to unlock loyalty stats`}
                    </Text>
                  </View>
                  <View
                    style={{
                ...
                <Grid style={{ marginTop: -15 }}>
                  ...
                  >
                    <Text style={{ fontSize: 16 }}>
                      {this.state.tripInfo.today_trips
                        ? this.state.tripInfo.today_trips
                        : 0}
