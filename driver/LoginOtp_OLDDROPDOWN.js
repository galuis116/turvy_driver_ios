...
const LoginOtp = ({props}) => {
   ...
   const _renderItem = item => {
            ...
            <View style={styles.item}>
                <Text style={styles.textItem}>{item.nicename}</Text>  
            </View>
            );
        };
    const _renderItemsel = (item, unSelect) => {
   			console.log("RENDER selected",item);
            return (
            <View style={styles.item}>
                <Text style={styles.textItem}>{item.nicename}</Text>  
            </View>
    	...
    	<Dropdown
            ...
            onChange={(item) => {
		        ...
		        renderItem={item => _renderItem(item)}
		         renderSelectedItem={(item, unSelect) => _renderItemsel(item,unSelect)}
