          ...
          <ScrollView style={{ backgroundColor: "aliceblue" }}>
            ...
            >
              ...
              <View>
                <Text style={{ fontSize: 24, color: "#FFF" }}>
                  {this.state.selectedTrip.payment}
                </Text>
              </View>
            </View>
            ...
            <Grid style={{ flex: 1, flexDirection: "row", paddingTop: 10 }}>
              ...
              <Row size={12} style={{ height: 65 }}>
                <Col size={8}>
                  ...
                  <Text style={localStyle.textColor}>
            ...
            <Grid>
              <Row style={localStyle.statOuter}>
                ...
                <Col style={localStyle.stipStat}>
                  <Text style={localStyle.textStatR}>
                    {this.state.selectedTrip.serviceType}
                  </Text>
                </Col>
              </Row>
            </Grid>
            ...
            <Grid>
              <Row style={localStyle.statOuter}>
                ...
                <Col style={localStyle.stipStat}>
                  <Text style={localStyle.textStatR}>
                    {this.state.selectedTrip.start_date}
                  </Text>
                </Col>
              </Row>
            </Grid>
            {this.state.selectedTrip.tripStatus === "self_cancel" ? (
              <Grid>
                ...
                <Row style={localStyle.statOuter}>
                  ...
                  <Col style={localStyle.stipStat}>
                    <Text style={localStyle.textStatR}>
                      {this.state.selectedTrip.statusText}
                    </Text>
                  </Col>
                </Row>
                <Row style={localStyle.statOuter}>
                  ...
                  <Col style={localStyle.stipStat}>
                    <Text style={localStyle.textStatR}>
                      {this.state.selectedTrip.cancel_reason}
                    </Text>
                  </Col>
                </Row>
              </Grid>
            ) : this.state.selectedTrip.tripStatus ===
              "self_cancel_after_5min_wait" ? (
              <Grid>
                <Row style={localStyle.statOuter}>
                  <Col style={localStyle.stipStat}>
                    <Text style={localStyle.textStatL}>
                      Cancel fee including waiting charge
                    </Text>
                  </Col>
                  <Col style={localStyle.stipStat}>
                    <Text style={localStyle.textStatR}>
              ...
              <Grid>
                ...
                {this.state.selectedTrip.payment_tip > 0 && (
                  <Row style={localStyle.statOuter}>
                    ...
                    <Col style={localStyle.stipStat}>
                      <Text style={localStyle.textStatR}>
                        A${this.state.selectedTrip.payment_tip}
                      </Text>
                    </Col>
                  </Row>
                )}
                ...
                <Row style={localStyle.statOuter}>
                  <Col>
                    ...
                    <Row
                      style={[
                        localStyle.innerRow2,
                        localStyle.darkBottomBorder,
                        { paddingBottom: 15 },
                      ]}
                    >
                      <Col style={localStyle.stipStat}>
                    ...
                    >
                      <Col style={localStyle.stipStat}>
                        <Text
                          style={[localStyle.textStatL, localStyle.heading]}
                        >
                          Your Earning
                        </Text>
                      </Col>
                      <Col style={localStyle.stipStat}>
                        <Text
                          style={[localStyle.textStatR, localStyle.heading]}
                        >
                          {this.state.selectedTrip.payment}
                        </Text>
                      </Col>
                    ...
                    >
                      <Col style={localStyle.stipStat} size={8}>
                        <Text
                          style={[localStyle.textStatL, localStyle.pageText]}
                        >
                          This show your trip balance. Which is the trip fare
                          minus service fee and including any reimbursements for
                          toll or airport charges you may have paid. Trip
                          balance will update to include any tips received by a
                          rider after a trip.
                        </Text>
                      </Col>
                      <Col size={4}></Col>
                    ...
                    <Row style={[localStyle.innerRow2]}>
                      ...
                      <Col style={localStyle.stipStat}>
                        <Text style={[localStyle.textStatR]}>
                          A${payData.booking_charge}
                        </Text>
                      </Col>
                    </Row>
                    <Row
                      style={[localStyle.innerRow, localStyle.darkBottomBorder]}
                    >
                      <Col style={[localStyle.stipStat, { paddingLeft: 20 }]}>
                        <Text style={[localStyle.textStatL]}>
                          Booking fee (deduction)
                        </Text>
                      </Col>
                      <Col style={localStyle.stipStat}>
                        <Text style={[localStyle.textStatR]}>
                    ...
                    <Row style={[localStyle.innerRow, localStyle.bottomBorder]}>
                      <Col style={localStyle.stipStat}>
                        <Text style={localStyle.textStatL}>
                          NSW Government Transport Levy
                        </Text>
                      </Col>
                      <Col style={localStyle.stipStat}>
                        <Text style={localStyle.textStatR}>
                          A${payData.nsw_gtl_charge}
                        </Text>
                      </Col>
                    </Row>
                    <Row
                    ...
                    <Row style={[localStyle.innerRow2, { paddingBottom: 15 }]}>
                      <Col style={localStyle.stipStat} size={8}>
                        <Text
                          style={[localStyle.textStatL, localStyle.pageText]}
                        >
                          These charges related to obligations imposed by
