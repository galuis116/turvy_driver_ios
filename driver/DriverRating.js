...
export default class DriverRating extends React.Component {
  ...
  async submit() {
    ...
    //(Number) = book_id
    await fetch(
      DOMAIN + "api/driver/book/feedback/" + this.state.bookingresponse.id,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
                  ...
                  >
                    ...
                    <Col style={{ alignItems: "flex-end" }}>
                      ...
                      <Text style={{ fontSize: 12, fontWeight: "bold" }}>
                        {this.state.tripTime.arrivalTime}
                      </Text>
                    </Col>
                  </Row>
                </View>
              ...
              <Row size={12}>
                ...
                <Col size={2}>
                  <Text style={{ fontSize: 13, color: "grey" }}>
                    {this.state.tripTime.pickupTime}
                  </Text>
                </Col>
              </Row>
            </Row>
              ...
              <Col>
                {this.state.riderRating === 1 ? (
                  <Text style={{ fontSize: 15, textAlign: "center" }}>
                    You rated {this.state.bookingresponse.rider_name}{" "}
