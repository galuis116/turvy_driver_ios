  						...
  						<View style={{paddingTop:30,marginLeft:10,marginRight:10}}>
        					...
        					<View style={{flex:1}}>
				          	...
				          	<View style={[{height: 50,marginBottom:20}]}>
							        ...
							        <Picker style={{ height:50, width: '100%', backgroundColor: "transparent", overflow:'hidden'}} selectedValue={this.state.phoneCode+'-'+this.state.countryId} onValueChange={(itemValue, itemIndex) => {
							        ...
							        }} mode="dialog" itemStyle={{marginTop:-85, }}>
							...
							this.state.country.map((val, index) =>{
				          	...
				          	<View style={[{borderColor : this.state.stateError ? 'red' : '#ddd' }]}>
					        	...
					        	selectedValue={this.state.stateval}  itemStyle={{marginTop:-80,}}>
						      ...
						      selectedValue={this.state.city}  itemStyle={{marginTop:-80, }}>
