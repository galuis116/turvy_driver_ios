                    ...
                    <Grid style={{justifyContent:'center',alignContent:'center',width:'100%'}}>
                    	...
                    	<Row>
                        	<Col>
                                ...
                                <Text style={{alignItems:'center',fontSize:16,color:'gray',padding:15,lineHeight:25,paddingHorizontal:15}}>Turvy Driver uses the camera to take your profile picture.</Text>
