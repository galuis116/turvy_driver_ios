...
export default class LocationEnableScreen extends React.Component {
  ...
  async componentDidMount() {
    ...
    if (status === "authorized" || status === "unavailable") {
      // Tracking is authorized; you can start collecting data.
      console.log("trackingPermission_authorized");
      this.intialLoad();
    } else {
          ...
          >
            <Row style={{ height: 180 }}>
              <Col style={{ alignItems: "center" }}>
                <Image source={imagemarker} style={styles.servicebocimage} />
              </Col>
            </Row>
            <Row style={{ height: 50 }}>
              <Col style={{ alignItems: "center" }}>
            ...
            <Row>
              <Col>
                ...
                >
                  Turvy Driver collects location data to enable current location
                  for trip request and airport queue even when the app is
                ...
                >
                  Turvy Driver collects background location when using a third
                  party map like google or waze for navigation or app in
                  background while the trip is running, then collects background
                  location for updating driver location on rider's map even when
                ...
                >
                  Turvy Driver uses the camera to take your profile picture.
                </Text>
              </Col>
            </Row>
          </Grid>
